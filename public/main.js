var app = (function () {
      ...
      m.$on("click", e[4]),
      {
        c() {
          (t = w("header")),
            ...
            (l = x()),
            (u = w("h1")),
            (u.textContent = "Dreamcatcher Heardle"),
            (c = x()),
            (d = w("div")),
            Q(h.$$.fragment),
            (f = x()),
  ...
  function Nt(t) {
    ...
    return {
      c() {
        (n = w("div")),
          (n.innerHTML =
            '<p class="mb-3">A clone of <a href="https://www.heardle.app/" title="Heardle">Heardle</a>, and <a href="https://heardle-kpop.glitch.me/" title="Heardle">K-Pop Heardle</a> but for Dreamcatcher songs.</p> \n\n<p class="mb-3">Each Dreamcatcher Heardle is randomly chosen from Dreamcatcher\'s discography.</p> \n\n\n\n<p class="text-xs mb-3 text-custom-line">Prepared with <a href="https://developers.soundcloud.com">Soundcloud</a>,\n    <a href="https://svelte.dev">Svelte</a>,\n    <a href="https://tailwindcss.com">Tailwind</a>,\n    <a href="https://fonts.google.com/noto/specimen/Noto+Serif+Display">Noto Serif Display</a>, <a href="https://fonts.google.com/noto/specimen/Noto+Sans">Noto Sans</a>,\n    <a href="https://iconsvg.xyz">IconSVG</a>, <a href="https://momentjs.com">momentjs</a>,\n    <a href="https://tarekraafat.github.io/autoComplete.js/#/">autocomplete.js</a>, and powered by <a href="https://glitch.com/">Glitch</a>. <a href="https://omakase.studio" title="Studio Omakase">Served omakase / お任せ</a>. Dreamcatcher version made by mirai#1201 and susan#7331.</p>'),
          M(n, "class", "text");
      },
      m(e, t) {
        g(e, n, t);
  ...
  function jt(e, t, n) {
    ...
    return (
      P(async function () {
        (async function () {
          const e = await fetch(
            "https://Dreamcatcher-heardle.glitch.me/supporters.json"
          );
          return await e.json();
        })().then((e) => {
          n(0, (r = e.supporters));
      ...
      (u = new Bt({})),
      {
        c() {
          (n = w("p")),
            ...
            (s = w("p")),
            (s.innerHTML =
              '<p class="mb-3">If you\'ve enjoyed playing Dreamcatcher Heardle, then please consider supporting the <a href="https://ko-fi.com/heardle">real Heardle devs</a>.</p>'),
            (i = x()),
            (o = w("div")),
            Q(a.$$.fragment),
            (l = x()),
      ...
      (O = new Rt({})),
      {
        c() {
          ...
          (o = x()),
            ...
            (m = w("div")),
            (k = w("div")),
            (k.textContent = "Next Dreamcatcher song in:"),
            (b = x()),
            Q(S.$$.fragment),
            (D = x()),
            (T = w("div")),
  ...
  function an(e) {
    ...
    return {
      c() {
        (t = _("You got today's Dreamcatcher Heardle within the first ")),
          (n = _(s)),
          (r = _(" seconds."));
      },
      m(e, s) {
  ...
  function ln(e) {
    ...
    return {
      c() {
        (t = _("You got today's Dreamcatcher Heardle within ")),
          (n = _(o)),
          (r = _("\n                second")),
          (s = _(a)),
          (i = _("."));
  ...
  function un(t) {
    ...
    return {
      c() {
        n = _("You didn't get today's Dreamcatcher Heardle. Better luck tomorrow!");
      },
      m(e, t) {
        g(e, n, t);
      },
  ...
  function fn(e, t, n) {
    ...
    return (
      ...
      [
        ...
        c,
        () => {
          let e = "Dreamcatcher Heardle #" + (s.id + 1),
            t = "";
          a
          ...
          for (let e = 0; e < i.maxAttempts; e++)
            r.length > e
              ? 1 == r[e].isCorrect
                ...
                : (t += "🟥")
              : (t += "⬜️");
          let o = e + "\n\n" + t + "\n\nhttp://Dreamcatcher-heardle.glitch.me/";
          if (
            !navigator.share ||
  ...
  const Cn = ue([
    ...
    On = {
      subscribe: ue(
        [
          {
            url: "https://soundcloud.com/machii1999/chase-me-dreamcatcher",
            answer: "Chase Me",
          },
		  {
            ...
            url: "https://soundcloud.com/jirousaki/you-and-i",
            answer: "YOU AND I",
          },{
            url: "https://soundcloud.com/aria-482/dreamcatcher-odd-eye",
            answer: "Odd Eye",
          },{
            url: "https://soundcloud.com/wickedlvst/dreamcatcher-good-night",
            answer: "GOOD NIGHT",
          },{
            url: "https://soundcloud.com/l2share61/dreamcatcher-what",
            answer: "What",
          },{
            url: "https://soundcloud.com/nicole-velazquez-273691725/eclipse-dreamcatcher",
            answer: "Eclipse",
          },{
            url: "https://soundcloud.com/yyxyjichu/dreamcatcher-scream-1",
            answer: "Scream",
          },{
            url: "https://soundcloud.com/user-103424529/dreamcatcher-fly-high",
            answer: "Fly High",
          },{
            url: "https://soundcloud.com/user-103424529/dreamcatcher-over-the-sky",
            answer: "Over the Sky",
          },{
            url: "https://soundcloud.com/talita-candido-1/dreamcatcher-rose-blue-prod-esti",
            answer: "R.o.S.E BLUE (Prod ESTi)",
          },{
            url: "https://soundcloud.com/myy19/dreamcatcher-breaking-out",
            answer: "Breaking Out",
          },{
            url: "https://soundcloud.com/user-746912196/because-dreamcatcher-band-live",
            answer: "BEcause",
          },{
            url: "https://soundcloud.com/l2share83/dreamcatcher-deja-vu",
            answer: "Deja Vu",
          },{
            url: "https://soundcloud.com/illumate1/endless-night",
            answer: "Endless Night",
          },{
            url: "https://soundcloud.com/talita-candido-1/dreamcatcher-no-more",
            answer: "No More",
          },{
            url: "https://soundcloud.com/insomnia-666-728529957/dreamcatcher-boca",
            answer: "BOCA",
          },{
            url: "https://soundcloud.com/l2share66/dreamcatcher-full-moon",
            answer: "Full Moon",
          },
        ],
        Pn
    ...
    return {
      c() {
        (t = w("meta")),
          ...
          (C = x()),
          H && H.c(),
          (An.title = "Dreamcatcher Heardle"),
          M(t, "name", "description"),
          M(
            t,
            "content",
            "Guess the Dreamcatcher song from the intro in as few tries as possible"
          ),
          M(n, "rel", "apple-touch-icon"),
          M(n, "sizes", "180x180"),
          M(n, "href", "https://cdn.discordapp.com/attachments/822443914836705291/961416958203531324/DREAMCATCHER_KPOP_GIRL_GROUP_WALLPAPER_LOGO.png"),
          M(s, "rel", "icon"),
          M(s, "type", "image/png"),
          M(s, "sizes", "32x32"),
          M(s, "href", "https://cdn.discordapp.com/attachments/822443914836705291/961416958203531324/DREAMCATCHER_KPOP_GIRL_GROUP_WALLPAPER_LOGO.png"),
          M(i, "rel", "icon"),
          M(i, "type", "image/png"),
          M(i, "sizes", "16x16"),
          M(i, "href", "https://cdn.discordapp.com/attachments/822443914836705291/961416958203531324/DREAMCATCHER_KPOP_GIRL_GROUP_WALLPAPER_LOGO.png"),
          M(o, "rel", "manifest"),
